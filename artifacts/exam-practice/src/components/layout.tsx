...
import { BookOpen, History, LayoutDashboard, LogOut, FileText } from "lucide-react";
    ...
    <div className="min-h-screen bg-background flex flex-col md:flex-row">
      <aside className="w-full md:w-64 border-b md:border-b-0 md:border-r border-border bg-card p-6 flex flex-col">
        <div className="mb-10">
          ...
          <p className="text-sm text-muted-foreground mt-1 tracking-tight">Claude Certified Architect</p>
        </div>
